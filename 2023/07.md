...
1. Proposals
    ...
    |   | 1     | 30m     | [Integer and Modulus Math](https://github.com/tc39/proposal-integer-and-modulus-math/blob/phoddie-patch-1/README.md) update | Peter Hoddie, Patrick Soquet |
