...
1. Proposals
    ...
    |   3   |   15m   | Update on [Top-level await](https://github.com/tc39/proposal-top-level-await), including [layering for ServiceWorker](https://github.com/tc39/proposal-top-level-await/pull/128) | Daniel Ehrenberg |
