...
Park in guest parking at [building 20](https://goo.gl/maps/atfiWWvkbAA2) and enter through the Zone 1 lobby.
Check in with reception/security and they will ping someone to come and get you.
...
1. Other Administrative Matters
  1. Determine 2017 TC39 meeting dates, locations, and hosts.
...
1. Timeboxed agenda items
  ...
  1. 45 Minute Items
  1. 60 Minute Items
    1. [LineTerminator normalisation: implementation feedback for `F.p.toString`](https://github.com/tc39/Function-prototype-toString-revision/issues/19) (Michael Ficarra, Wed/Thu only)
