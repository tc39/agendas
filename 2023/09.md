...
1. Proposals
    ...
    | | 0 | 30m | [joint iteration](https://github.com/michaelficarra/proposal-joint-iteration) for Stage 1 (slides TBD) | Michael Ficarra |
    | | 0 | 30m | [iterator sequencing](https://github.com/michaelficarra/proposal-iterator-sequencing) for Stage 1 (slides TBD) | Michael Ficarra |
