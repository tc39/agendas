...
1. Proposals
    ...
    |:-:|:-----:|:-------:|-------|-----------|
    |   | 3 | 15m | iterator helpers: change Symbol.iterator fallback from callable check to undefined check ([PR](https://github.com/tc39/proposal-iterator-helpers/pull/272)) (slides TBD) | Michael Ficarra |
    |   | 3 | 30m | iterator helpers: remove IsCallable check on NextMethod, deferring errors to Call site ([PR](https://github.com/tc39/proposal-iterator-helpers/pull/274)) (slides TBD) | Michael Ficarra |    
