...
1. Proposals
    ...
    | 3 | 15m | [Explicit Resource Management](https://github.com/tc39/proposal-explicit-resource-management) for Stage 4 ([spec pr](https://github.com/tc39/ecma262/pull/3000), slides TBD) | Ron Buckton |
    ...
    | 3 | 30m | `Array.fromAsync` for Stage 4 ([spec pull request](https://github.com/tc39/ecma262/pull/3581)) | J. S. Choi |
    ...
    | 2 | 60m | [AsyncContext](github.com/tc39/proposal-async-context/) web integration brainstorming | Andreu Botella |
