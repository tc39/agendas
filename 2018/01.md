...
1. Timeboxed agenda items
 ...
        1. [`BigInt`](https://github.com/tc39/proposal-bigint) status update ([significant recent change](https://github.com/tc39/proposal-bigint/pull/106)) (Daniel Ehrenberg)
        ...
        1. Operator Overloading for Stage 1 (Keith Cirkel)
...
1. Non-timeboxed agenda items
    ...
    1. New proposals
        1. TC39 should endorse use of a (one-of, not only one specific recommended) parsing linter or actual compiler, not any particular semicolon style (Brendan Eich)
