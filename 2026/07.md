...
1. Proposals
    ...
    |:-----:|:-------:|-------|-----------|
    | 2 | 30m | [Thenable Curtailment / SafeResolve](https://github.com/tc39/proposal-thenable-curtailment) for 2.7 ([slides (in progress)](https://docs.google.com/presentation/d/1kHq_UqMHGGT8ena8yMlJKgHmohDVqxJvV4hiCB12HtU/view?)) | Matthew Gaudet |
    ...
    | 0 | 45m | [linear matching](https://github.com/michaelficarra/proposal-linear-matching) for Stage 1 (slides TBD) | Michael Ficarra |
    | 0 | 30m | [Fused Multiply-Add](https://github.com/waldemarhorwat/fma) for Stage 1 or 2 (slides TBD) | Waldemar Horwat |
