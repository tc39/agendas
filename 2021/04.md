...
1. Proposals
    ...
    | | 3 | 1m  | [Temporal](https://github.com/tc39/proposal-temporal/) update: Normative changes upon which Stage 3 was conditional, have been resolved. EOM | Philip Chimento |
