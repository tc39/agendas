...
1. Proposals
    ...
    |   | 1     | 30m     | Bikeshedding [bind-this](https://github.com/tc39/proposal-pattern-matching) syntax (slides coming; see also [issue thread](https://github.com/tc39/proposal-bind-this/issues/10) and [TAB’s call-this explainer](https://github.com/tabatkins/proposal-call-this-operator)) | J. S. Choi |
