...
1. Proposals
    ...
    |   | 3     | 30m     | [Intl DisplayNames v2](https://github.com/tc39/intl-displaynames-v2) for Stage 4 ([Spec](https://tc39.es/intl-displaynames-v2/), Slides) | Frank Yung-Fong Tang |
    |   | 3     | 20m     | [Extend TimeZoneName Option Proposal](https://github.com/tc39/proposal-intl-extend-timezonename) for Stage 4 ([Spec](https://tc39.es/proposal-intl-extend-timezonename/), Slides) | Frank Yung-Fong Tang |
