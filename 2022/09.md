...
1. Proposals
    ...
    |   | 2     | 60m     | [Iterator Helpers](https://github.com/tc39/proposal-iterator-helpers) for stage 3 (slides TBD) | Michael Ficarra |
    |   | 2     | 60m     | [Array.fromAsync](https://github.com/tc39/proposal-array-from-async) for Stage 3 (slides TBD) | J. S. Choi |
    |   | 1     | 30m     | [Well-Formed Unicode Strings](https://github.com/tc39/proposal-is-usv-string) for stage 2 (slides TBD) | Michael Ficarra |
...
1. Michael Ficarra cannot be present during the first 90 minutes of [this TPAC session](https://www.w3.org/events/meetings/44a37fa8-914e-423c-9a2f-c4fb00c5410e).
