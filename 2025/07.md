...
1. Project Editors’ Reports
    ...
    1. [ECMA402](https://github.com/tc39/ecma402) Status Updates (15m, [slides](https://notes.igalia.com/p/2MUpJraYd))
...
1. [Web compatibility issues](https://github.com/tc39/ecma262/issues?utf8=✓&q=is%3Aopen+label%3A%22web+reality%22+is%3Aissue) / [Needs Consensus PRs](https://github.com/tc39/ecma262/pulls?q=is%3Apr+is%3Aopen+label%3A%22needs+consensus%22)
    ...
    |:-------:|-------|-----------|
    | 10m     | Missing name property for `%IntlSegmentsPrototype%[%Symbol.iterator%]` ([tc39/ecma402#1015](https://github.com/tc39/ecma402/pull/1015), [slides](https://notes.igalia.com/p/Nouz41CnU)) | Ujjwal Sharma |
...
1. Overflow from timeboxed agenda items (in insertion order)
    ...
    | topic | presenter |
    |-------|-----------|
    | Measure/Amount continuation | Jesse Alama |
