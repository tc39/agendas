...
- **Total duration of scheduled discussions**: ![dynamically computed total of timeboxes on the agenda](https://tc39-agenda-time.nicolo-ribaudo.deno.net/2026/07/)
...
1. Secretary's Report ([slides](./tc39-2026-029.pdf)) (Samina Husain, 15m)
...
1. Task Group Reports
    ...
    1. TG3: Security (1m)
    1. TG4: Source Maps (2m, [slides](https://docs.google.com/presentation/d/1xIKd9vSR01B3Nx2pSfR2XegZbAxVbKE-m4Pro0tji2s))
    1. TG5: Experiments in Programming Language Standardization ([slides](https://docs.google.com/presentation/d/1gJ-bB4C5UdXmssiEsK2gnMdm1janUYfqelY_stdMD04)) (Michael Ficarra, 5m)
...
1. [Web compatibility issues](https://github.com/tc39/ecma262/issues?utf8=✓&q=is%3Aopen+label%3A%22web+reality%22+is%3Aissue) / [Needs Consensus PRs](https://github.com/tc39/ecma262/pulls?q=is%3Apr+is%3Aopen+label%3A%22needs+consensus%22)
    ...
    |:-------:|-------|-----------|
    | 30m | ⌛️ Needs-consensus PR: Support BigInt coercion of integers expressed as exponential-notation strings ([#3857](https://github.com/tc39/ecma262/pull/3857), [slides](https://docs.google.com/presentation/d/1kPYmR8LkoV4AZpSM_ezHCyR2givdk9OiQlwiXHdah4M/edit?usp=sharing)) | Richard Gibson |
...
1. Proposals
    ...
    |:-----:|:-------:|-------|-----------|
    | 3 | 45m | [Import Defer](https://tc39.es/proposal-defer-import-eval/) Stage 3 updates ([slides](https://docs.google.com/presentation/d/1pH5SCZRJaN-HFeOn0WZ9KD64vvunPZdxhyYuMMHZLC8)) | Caio Lima &  Nicolò Ribaudo |
    ...
    | 2 | 30m | [JSON.parseImmutable](https://github.com/tc39/proposal-json-parseimmutable) stage 2 update ([issues](https://github.com/tc39/proposal-json-parseimmutable/issues)) | Ashley Claymore & Peter Klecha |
    ...
    | 1 | 60m | [Composites](https://github.com/tc39/proposal-composites) update ([slides](https://docs.google.com/presentation/d/1vTRHdRzIZQF69Q5Nx_VDkCkm2mn1rJK-CTtDiSqA9x0/)) | Ashley Claymore |
...
- Caio Lima (CLA) unavailable on Thursday 23rd.
- Aurèle Barrière (AUR) is unavailable on the 23rd and would like to attend the Linear Matching topic.
- Nicolò Ribaudo is unavailable on Thursday before lunch and on Wednesday for the 30 min right before and right after lunch.

#### Late-breaking Schedule Constraints

- Kevin Gibbons (KG) would prefer not to present during the first hour of any day
- Ron Buckton (RBN) will not be present on Monday, July 20th after 2pm ACT (1pm ET) and would like to be present for Declarations in Conditionals.
- Shane F Carr is unavailable Monday 13:30-15:00, Tuesday 10:00-14:00, Thursday 10:00-11:40 (all times in ACT). Needed for his presentations and preferred but not required on Math FMA and Decimal.
