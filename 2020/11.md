...
1. Next meeting host and logistics &amp; 2021 Schedule (5m [slides](https://github.com/tc39/agendas/blob/master/2020/11.md))
...
1. Proposals
    ...
    |   | 3     | 45m     | [RegExp Matches Indices](https://github.com/tc39/proposal-regexp-match-indices) JSC Implementation feedback ([Slides](https://github.com/tc39/proposal-regexp-match-indices/blob/master/RegExp%20Match%20Indices%20JSC%20Implementation%20Feedback%20Nov%202020.pdf)) | Michael Saboff |
    ...
    |   | 0     | 60m     | Vision for concurrent JS + constellations of proposals | Shu-yu Guo |
...
1. Longer or open-ended discussions
    ...
    |   | 45      | :hourglass: Regex: Adopting Unicode behavior for multi-code-point character classes | Markus Scherer, Mathias Bynens |
...
| Dates                    | Location                       | Host                    |
|--------------------------|--------------------------------|-------------------------|
| 2021-01-25 to 2021-01-28 | Remote: San Francisco PT       | N/A                     |
