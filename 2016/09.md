...
1. Timeboxed overflow from previous meeting
  1. 15 Minute Items
    1. Do we want to revisit class "mixins" (ie. where the _ClassHeritage_ evaluates to a super class which ` IsConstructor(superclass) === false`)? (Rick Waldron)
      1. Basic plan: https://gist.github.com/rwaldron/cc607ca68d076c6332f771ac7db17228
      1. https://github.com/rwaldron/tc39-notes/blob/master/es6/2012-07/july-26.md#maxmin-class-semantics
      1. https://github.com/rwaldron/tc39-notes/blob/master/es6/2013-01/jan-31.md#class-extends-throw-on-non-constructor
      1. Relevant Spec: https://tc39.github.io/ecma262/#sec-runtime-semantics-classdefinitionevaluation
  1. 30 Minute Items
