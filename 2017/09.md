...
1. Timeboxed agenda items
    1. 15 Minute Items
        ...
        1. ️:hourglass: [Atomics.waitAsync](https://github.com/tc39/proposal-atomics-wait-async/blob/master/PROPOSAL.md) for stage 2 (Shu-yu Guo for Lars Hansen *in absentia*) ([slides](https://docs.google.com/presentation/d/11I90n1TD8JXL1euckt1YWS-VD_fdm_s4MNTiu9FgT5Q/edit?usp=sharing))
    ...
    1. 30 Minute Items
        ...
        1. ️:hourglass: [Referential destructuring](https://github.com/meteor/proposal-referential-destructuring) for Stage 1 (Ben Newman)
    1. 45 Minute Items
