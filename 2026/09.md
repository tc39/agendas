...
1. Project Editors’ Reports
    ...
    1. [ECMA404](https://www.ecma-international.org/publications/standards/Ecma-404.htm) Status Updates (10m)
...
1. Proposals
    ...
    | 2 | 30m | [Amount](https://github.com/tc39/proposal-amount/) Stage 2 Update (slides TBA) | Jesse Alama |
    | 2 | 30m | [export defer](https://github.com/tc39/proposal-deferred-reexports/) for Stage 2.7 | Nicolò Ribaudo & Caio Lima |
    | 1 | 20m | [Include default in `export *`](https://github.com/tc39/proposal-export-star-default) for Stage 2 & 2.7 | Nicolò Ribaudo |
...
1. Longer or open-ended discussions
    ...
    | timebox | topic | presenter |
    |:-------:|-------|-----------|
    | 60m     | reworking Cover and Supplemental Grammars (slides TBA) | Mikhail Barash |
...
- Nicolò Ribaudo would prefer *Include default in `export *`* to precede *export defer*. I _very strongly prefer_ to present after 15:00; if I need to present earlier I need to know the day before (and still, even if before 15:00 later is better).
