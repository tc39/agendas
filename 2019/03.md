...
1. ~~Report from the Ecma Secretariat~~ (15m, Istvan Sebestyen) [slides](https://github.com/tc39/Reflector/files/2999399/tc39-2019-016.pdf)
1. ~~Project Editors’ Reports~~
    ...
    1. ~~[ECMA402](https://github.com/tc39/ecma402) Status Updates~~ (15m) ([Slides](https://docs.google.com/presentation/d/1wsTyg0d97zR7tpSNuu1wpTsplNfV0RMVh9e-e_2wIDg/edit))
        1. ~~Editorship updates~~ ([Slides](https://docs.google.com/presentation/d/1D2vP7GMknBFaXkuBteCLk5bhL-PN_j7z2yK4MmmfYnE/edit#slide=id.p))
        1. ~~Request to become a TC39 Task Group~~
    1. ~~ECMA404 Status Updates~~ (15m)
    1. ~~Test262 Status Updates~~ (15m)
1. ~~Updates from the CoC Committee~~ (15m)
1. ~~Liaison reports~~
    1. ~~Ecma TC53~~ (20m, Peter Hoddie, Mark Miller) [slides](https://www.icloud.com/keynote/0br90r7j82NFdnqezliqGAblQ#tc53_liason_report_-_3/19)
1. ~~[Web compatibility issues](https://github.com/tc39/ecma262/issues?utf8=✓&q=is%3Aopen+label%3A%22web+reality%22+is%3Aissue) / [Needs Consensus PRs](https://github.com/tc39/ecma262/pulls?q=is%3Apr+is%3Aopen+label%3A%22needs+consensus%22)~~
    ...
    | 15m | ~~[Normative: CreateDynamicFunction early concatenates bodyText](https://github.com/tc39/ecma262/pull/1479)~~ ([slides](https://docs.google.com/presentation/d/1mGBFCw4M37q4cF8JHnXzaLI2wLdOxoVEfq9RL_xMRW0/edit#slide=id.p)) | Leo Balter |
...
1. Proposals
    ...
    | 1 | 30m | [Uniform parsing of quasi-standard Date.parse input](https://github.com/tc39/proposal-uniform-interchange-date-parsing) for Stage 2 ([slides](https://docs.google.com/presentation/d/1LuJzeR7Y-e-LcQObQesJfJsIVGkiZCMoZhVMO5OxIoc/edit)) | Richard Gibson |
