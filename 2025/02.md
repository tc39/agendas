...
Deadline for advancement eligibility: [February 18th, 10:00 PST](https://www.timeanddate.com/countdown/generic?p0=1440&iso=20250218T18&msg=TC39%20Submission%20deadline)
...
1. Proposals
    ...
    |:-----:|:-------:|-------|-----------|
    |  3    | 30m     | [Intl Locale Info API](https://github.com/tc39/proposal-intl-locale-info) to Stage 4 ([PR](https://github.com/tc39/ecma402/pull/942), slide TBW) | Frank Yung-Fong Tang |
    |  -1   | 30m     | [Error Stack Accessor](https://github.com/ljharb/proposal-error-stack-accessor) to stage 1 or 2 | Jordan Harband |
