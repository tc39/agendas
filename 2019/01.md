...
1. [Web compatibility issues](https://github.com/tc39/ecma262/issues?utf8=✓&q=is%3Aopen+label%3A%22web+reality%22+is%3Aissue) / [Needs Consensus PRs](https://github.com/tc39/ecma262/pulls?q=is%3Apr+is%3Aopen+label%3A%22needs+consensus%22)
    ...
    |:-------:|-------|-----------|
    | 45m | Amending the memory to support ARMv8 `LDA`/`STL` codegen | Shu-yu Guo & Conrad Watts (invited expert) |
...
1. Proposals
    ...
    | 3 | 15m | Update on [sequence properties in Unicode property escapes](https://github.com/tc39/proposal-regexp-unicode-sequence-properties) | Mathias Bynens |
