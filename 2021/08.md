...
1. Longer or open-ended discussions
    ...
    | ✓ | timebox | topic | presenter |
    |:-:|:-------:|-------|-----------|
    |   | 60m     | Response to ECMA / LF Proposed Partnership ([slides](https://github.com/msaboff/tc39/blob/master/Built%20In%20Modules%20TC39%20June%202020.pdf)) | Michael Saboff
