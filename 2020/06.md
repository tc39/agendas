...
1. Proposals
    ...
    |   | 0     | 45m     | [Subclassing support in built-in methods delenda est](https://github.com/syg/proposal-rm-builtin-subclassing) for Stage 1 [slides](https://docs.google.com/presentation/d/1vJeJFueDwrj8ebXFdGsEO1J_Q-DzfU01dLEGVd26A9o/edit#slide=id.p) | Shu-yu Guo, Yulia Startsev |
