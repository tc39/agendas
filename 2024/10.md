...
1. Proposals
    ...
    | 3   | 15m | [`Promise.try`](https://github.com/tc39/proposal-promise-try/issues/15) for Stage 4
    ...
    | 2   | 30m | [Map.emplace](https://github.com/tc39/proposal-upsert): A New Hope (Stage 2 update)| Daniel Minor |
...
1. Longer or open-ended discussions
    ...
    | timebox | topic | presenter |
    |:-------:|-------|-----------|
    | 60m | Explicit compile hints | Marja Hölttä (Google) |
...
- Daniel Minor would prefer to present `Map.emplace` between 10am and 12pm, Wednesday or Thursday.
