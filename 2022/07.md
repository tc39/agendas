...
1. [Web compatibility issues](https://github.com/tc39/ecma262/issues?utf8=✓&q=is%3Aopen+label%3A%22web+reality%22+is%3Aissue) / [Needs Consensus PRs](https://github.com/tc39/ecma262/pulls?q=is%3Apr+is%3Aopen+label%3A%22needs+consensus%22)
    ...
    |   |      15 | [Avoid triggering `throw` in corner case in async generators](https://github.com/tc39/ecma262/pull/2818) | Kevin Gibbons |
...
1. Proposals
    ...
    |   |     3 |      30 | Relax range check in [NumberFormat v3](https://github.com/tc39/proposal-intl-numberformat-v3) and in ECMA402 Intl.DateTimeFormat (slides, PR1, PR2) | Frank Yung-Fong Tang (Google) |
