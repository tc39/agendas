...
1. Secretary's Report (15m, Samina Husain, [slides](./tc39-2026-037.pdf))
...
1. [Web compatibility issues](https://github.com/tc39/ecma262/issues?utf8=✓&q=is%3Aopen+label%3A%22web+reality%22+is%3Aissue) / [Needs Consensus PRs](https://github.com/tc39/ecma262/pulls?q=is%3Apr+is%3Aopen+label%3A%22needs+consensus%22)
    ...
    | 30m | ⌛️ [Establish normative conventions for invalid input strings: RangeError vs. TypeError](https://github.com/tc39/ecma262/pull/3982#issuecomment-5774277939) | Richard Gibson |
...
1. Short (≤30m) Timeboxed Discussions
    ...
    | 30m | structured TC39 data status update ([slides](https://docs.google.com/presentation/d/1Qr0soLiTxn6od612KAnkDttMDhyS1BBRmFjmd9ken8Q)) | Michael Ficarra, Jordan Harband |
...
1. Proposals
    ...
    | 3 | 30m | [Disallow Adding New Private Fields to Non-extensible Objects](https://github.com/tc39/proposal-nonextensible-applies-to-private) ([slides](https://docs.google.com/presentation/d/1AZYPsiU0LEwI-Hh4zRrW23DvwCMUF5wHjPS4pFh4j6E/edit?usp=sharing), [PR#12](https://github.com/tc39/proposal-nonextensible-applies-to-private/pull/12)) | Olivier Flückiger |
    | 2.7 | 30m | [ESM Phase Imports](https://github.com/tc39/proposal-esm-phase-imports) normative PRs for [Module source identity](https://github.com/tc39/proposal-esm-phase-imports/pull/63) and [Non-injective source imports](https://github.com/tc39/proposal-esm-phase-imports/pull/62) | Guy Bedford |
...
1. Longer or open-ended discussions
    ...
    | 15m     | Active proposals missing champions: `function-sent` (Stage 2), `collection-normalization` (Stage 2), `destructuring-private` (Stage 2) | Michael Ficarra |
    | 10m     | Stage 2 proposals missing Stage 2.7 reviewers: `collection-normalization`, `pipeline-operator`, `module-declarations`, `jobcallback-module` | Michael Ficarra |
