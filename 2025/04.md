...
1. Proposals
    ...
    |   1   | 60m     | Don't Not Panic (TODO links to updated OOM Must Fail Fast) update | Mark Miller |
    |   0   | 30m     | Strengthen Non-extensibility (TODO links) for stage 2.7 | Mark Miller |
