...
1. Proposals
    ...
    |   | 1     | 60m     | Stage Separation (pun intended) for [SES](https://github.com/tc39/proposal-ses) | Mark S. Miller |
    |   | 0     | 30m     | [Legacy reflection features for functions in JavaScript](https://github.com/claudepache/es-legacy-function-reflection) for Stage 1 | Mark S. Miller  (by Claude Pache, Jack Works) |
    ...
    |   | 0     | 30m     | [ArrayBuffer.fillRandom](https://github.com/rbuckton/proposal-arraybuffer-fillrandom) for Stage 1 | Ron Buckton |
    |   | 0     | 60m     | Extensions for Stage 1 | 贺师俊 (HE Shi-Jun) |
    |   | 3     | 15m     | [WeakRefs](https://github.com/tc39/proposal-weakrefs/) status update ([slides](https://docs.google.com/presentation/d/1a4hrdlEcpyKmBj6VtAVYDkokeW_HLFXcg11xIxhwlWM/edit#slide=id.p) (late addition, feel free to deprioritize) | Daniel Ehrenberg |
