...
1. Proposals
    ...
    |   | 3 | 10m | Iterator helpers: closing iterators which have not been iterated ([issue](https://github.com/tc39/proposal-iterator-helpers/issues/266), PR to come) | Kevin Gibbons |
