...
1. Short (≤30m) Timeboxed Discussions
    ...
    | timebox | topic | presenter |
    |:-------:|-------|-----------|
    | 30m | machine-readable source of truth for proposal info, delegate info, maybe even committee process info ([repo](https://github.com/michaelficarra/tc39-data), slides TBD) | Michael Ficarra |
