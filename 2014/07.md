...
Please register before 22nd of July 2014.
  ...
  1. ECMA-262 6th Edition
    ...
    2. Annex B: labelled FunctionDeclations (Allen)
      1. eg, foo: function f() {}
    2. Function parameter/let declaration name conflict rules (Allen)
    3. Review @@create design rationale and possible alternatives (Allen)
    2. Import-into-namespace syntax (Dave)
