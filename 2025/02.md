...
1. Proposals
    ...
    |   3   | 30m     | [Intl Locale Info API](https://github.com/tc39/proposal-intl-locale-info) Update in Stage 3 ([PR](https://github.com/tc39/ecma402/pull/942), slide TBW) | Frank Yung-Fong Tang |
    ...
    |   1   | 60m     | [Stable Formatting](https://github.com/tc39/proposal-stable-formatting) update ([PR](https://github.com/tc39/proposal-stable-formatting/pull/18), slides forthcoming) | Eemeli Aro |
