...
1. Proposals
    ...
    |:-:|:-----:|:-------:|-------|-----------|
    |   | 1     | 30m     | [Change Array by copy](https://github.com/tc39/proposal-change-array-by-copy) for Stage 2 ([spec](https://tc39.es/proposal-change-array-by-copy/), [slides-tbc](#)) | Robin Ricard & Ashley Claymore |
