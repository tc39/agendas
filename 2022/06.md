...
1. Proposals
    ...
    |   | 2     | 30m     | [JSON.parse source text access](https://github.com/tc39/proposal-json-parse-with-source) for Stage 3 ([spec](https://github.com/tc39/proposal-json-parse-with-source/blob/master/spec.html), slides pending) | Richard Gibson |
