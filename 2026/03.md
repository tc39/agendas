...
- **Total duration of scheduled discussions**: ![dynamically computed total of timeboxes on the agenda](https://tc39-agenda-time.nicolo-ribaudo.deno.net/2026/03/)
...
1. Project Editors’ Reports
    1. [ECMA262](https://github.com/tc39/ecma262) Status Updates ([slides](https://docs.google.com/presentation/d/19AryLFu9Crgiq0e-YeKu9Oms9j94mOFWQlXAtawzrWU)) (5m, Michael Ficarra)
...
1. Proposals
    ...
    | 3 | 15m | [Explicit Resource Management](https://github.com/tc39/proposal-explicit-resource-management) Conditional Stage 4 Status Update ([spec PR](https://github.com/tc39/ecma262/pull/3000), [test262 PRs](https://github.com/tc39/test262/pulls?q=is%3Apr+%5Bexplicit-resource-management%5D+), [slides](https://1drv.ms/p/c/934f1675ed4c1638/IQCRVZZRvm3sSp9rK19F2SMJAQpZaM-CTuIElCRvQXim9Fg?e=lUcddY)) | Ron Buckton |
    | 3 | 30m | [Intl Era/Month Code](https://github.com/tc39/proposal-intl-era-monthcode) for Stage 4 ([slides](https://notes.igalia.com/p/era-monthcode-stage-4#/), [PR](https://github.com/tc39/ecma402/pull/1044)) | Ben Allen |
    | 3 | 90m | [Temporal](https://github.com/tc39/proposal-temporal) for Stage 4 ([slides](https://ptomato.name/talks/tc39-2026-03/), [ECMA-262 PR](https://github.com/tc39/ecma262/pull/3759), [ECMA-402 PR](https://github.com/tc39/ecma402/pull/1044)) | Philip Chimento |
    | 2.7 | 20m | [Intl: Keep Trailing Zeros](https://github.com/tc39/proposal-intl-keep-trailing-zeros) for Stage 3 ([slides](https://docs.google.com/presentation/d/13zyaDAuriW2A4pwzklf0EZhOSUUmWqZxyIjzCcjWkXU/edit?usp=sharing)) | Eemeli Aro |
    | 2.7 | 60m | Update on [ESM Phase Imports](https://github.com/tc39/proposal-esm-phase-imports) ([slides](https://docs.google.com/presentation/d/1inTcnb4hugyAvKrjFX_XHTnxYaPW0rodWwn0VFmlq24/edit?usp=sharing), PRs [#56](https://github.com/tc39/proposal-esm-phase-imports/pull/56), [#58](https://github.com/tc39/proposal-esm-phase-imports/pull/58) (normative) & [#61](https://github.com/tc39/proposal-esm-phase-imports/pull/61) (normative)) | Guy Bedford |
    | 2 |  5m | Withdraw [Dynamic Import Host Adjustment](https://github.com/tc39/proposal-dynamic-import-host-adjustment) | Steve Hicks |
    | 2 | 15m | ⌛️ [RegExp Buffer Boundaries](https://github.com/tc39/proposal-regexp-buffer-boundaries) for Stage 2.7 or 3 ([slides](https://1drv.ms/p/c/934f1675ed4c1638/IQCTgpGYlj_dTblwh8sK7M9HAQRbd5eUz4b_XF4t1rxe_38?e=TDhJ9C), [test262 PR](https://github.com/tc39/test262/pull/4975)) | Ron Buckton |
    | 2 | 30m | [Error Stack Accessor](https://github.com/tc39/proposal-error-stack-accessor/issues/9) for Stage 2.7 | Jordan Harband |
    | 2 | 20m | [JSON.parseImmutable](https://github.com/tc39/proposal-json-parseimmutable) update ([slides](https://docs.google.com/presentation/d/1NXb3HWjt0BiVJl2SZlAVeSvZIBlzO1z9X28hJL28w7s)) | Peter Klecha |
    ...
    | 1 | 30m | [TypedArray concat](https://github.com/tc39/proposal-typedarray-concat) for Stage 2 ([slides](https://github.com/tc39/proposal-typedarray-concat/blob/tc39-plenary-march-2026/slides-export.pdf)) | James M Snell |
    | 1 | 30m | [TypedArray find within](https://github.com/tc39/proposal-typedarray-findwithin) for Stage 2 ([slides](https://github.com/tc39/proposal-typedarray-findwithin/blob/tc39-plenary-march-2026/slides-export.pdf)) | James M Snell |
    ...
    | 1 | 60m | [Amount](https://github.com/tc39/proposal-amount) for Stage 2 ([slides](https://docs.google.com/presentation/d/1SAD0bgB_SOWrtz1YZuySC4YHdMxBs0vTnS7buQa311c/edit?slide=id.g3cb9b164150_1_50#slide=id.g3cb9b164150_1_50)) | Ben Allen |
    | 1 | 60m | [Thenable Curtailment](https://github.com/tc39/proposal-thenable-curtailment) for Stage 2 ([Slides](https://docs.google.com/presentation/d/1i0jY_e-A3rkd9256VzirJdPVtHInYNGjtYq_KrTBMuo/edit?slide=id.g3cc3e467680_0_103#slide=id.g3cc3e467680_0_103)) | Matthew Gaudet |
    | 1 | 60m | [First-class Protocols](https://github.com/tc39/proposal-first-class-protocols) Update ([slides](https://tc39.es/proposal-first-class-protocols/slides/2026-03/)) | Lea Verou |
    ...
    | 0 | 30m | [Error code property](https://github.com/jasnell/proposal-error-code-property) for Stage 1, 2, or 2.7 ([slides](https://github.com/jasnell/proposal-error-code-property/blob/main/slides-export.pdf)) | James M Snell |

1. Longer or open-ended discussions

    | timebox | topic | presenter |
    |:-------:|-------|-----------|
    | 45m | Tree-shakeable methods ([slides](https://docs.google.com/presentation/d/1zy10o54PMuh2c9Liz6RH5R3bnBpe-3-sy0uEXbACzjQ/edit?usp=sharing)) | Evan B Winslow |
    | 60m | test262 coverage strategies | Richard Gibson |
    | 90m | Toward structured concurrency ([slides](https://docs.google.com/presentation/d/1vYh__pmW0QuIhxz9jPQbUXdkIrzD5p7Wjl6oTdKSBZI/edit?usp=sharing), [repo for discussions](https://github.com/bakkot/structured-concurrency-for-js)) | Kevin Gibbons |
