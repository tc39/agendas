...
1. Proposals
    ...
    |   | 3     | 15m     | [Intl.DisplayNames](https://github.com/tc39/proposal-intl-displaynames) for Stage 4 | Frank Yung-Fong Tang |
    ...
    |   | 1     | 60m     | [Builtin Modules](https://github.com/tc39/proposal-built-in-modules) for Stage 2 ([spec](https://github.com/tc39/proposal-built-in-modules/blob/master/spec.html), [slides](https://github.com/tc39/proposal-built-in-modules/blob/master/slides/BuiltInModules-For-Stage2-TC39-Sept-2020.pdf)) | Michael Saboff |
