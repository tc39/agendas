...
1. Longer or open-ended discussions
    ...
    |   | 60m     | Using WebAssembly as a polyfill for ECMAScript proposals (especially those in ECMA-402 via ICU4X) | Shane F. Carr (prefer Wednesday or Thursday) |
...
- Justin Grant's preference is to present Time Zone Canonicalization presentation in the CEST morning of any day (as long it's after Temporal's). The earlier, the better, but I'm flexible.
