...
* **How to access the building**: Check in with Visitor Reception in Lincoln Square's lobby, then take elevators to the 15th floor. A new badge is needed each day.
...
1. Short (&le;30m) Timeboxed Discussions
    ...
    | 5m      | Input requested on TC39 Invited Expert policy | Daniel Ehrenberg |
    | 5m      | 2019 Meeting planning update | Daniel Ehrenberg |
...
1. Longer or open-ended discussions (Thursday afternoon)
    ...
    | timebox | topic | presenter |
    |:-------:|-------|-----------|
    | 30m     | Open-ended discussion: How should we analyze complexity and cross-cutting concerns on syntax and library proposals? (overflow) | backup: Daniel Ehrenberg, other presenter wanted |
    | 30m     | Groups! For in-depth discussions and community feedback (overflow) ([slides](https://docs.google.com/presentation/d/1x2t8ggcpFlZ2zl1RjVgO5fmGjqXRxlkoqcGDKY5ksVg/edit#slide=id.p), [Reflector post](https://github.com/tc39/Reflector/issues/158)) (overflow) | Daniel Ehrenberg |
