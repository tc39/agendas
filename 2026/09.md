...
1. Proposals
    ...
    | 3 | 9m | [Dynamic Code Brand Checks](https://github.com/tc39/proposal-dynamic-code-brand-checks) for Stage 4 ([PR](https://github.com/tc39/ecma262/pull/3294)) | Nicolò Ribaudo |
    ...
    | 2 | 30m | [JSON.parse Options](https://github.com/tc39/proposal-json-parseimmutable) for Stage 2.7 | Peter Klecha & Ashley Claymore |
...
1. Longer or open-ended discussions
    ...
    | 60m     | It's about the agenda deadline (slides forthcoming but I am proposing changes to the deadline) | Chris de Almeida |
