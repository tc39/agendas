...
1. Short (≤30m) Timeboxed Discussions
    ...
    | timebox | topic | presenter |
    |:-------:|-------|-----------|
    | 30m | machine-readable source of truth for proposal info, delegate info, maybe even committee process info ([repo](https://github.com/michaelficarra/tc39-data), [demo](https://michaelficarra.github.io/tc39-data/), [slides](https://docs.google.com/presentation/d/1aP1LDkspsVlvjYRDN63bTIjzP6rz1m6eHbZooGNu9QA)) | Michael Ficarra |
