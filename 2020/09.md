...
1. Proposals
    ...
    |:-:|:-----:|:-------:|-------|-----------|
    |   | 3     | 10m     | Status update for [class fields](https://github.com/tc39/proposal-class-fields), [private methods](https://github.com/tc39/proposal-private-methods), [static class features](https://github.com/tc39/proposal-static-class-features/) (editorial: unified specification) | Daniel Ehrenberg and Ujjwal Sharma |
