...
1. Proposals
    ...
    | ✓ | 1     | 60m     | [Builtin Modules](https://github.com/tc39/proposal-built-in-modules) for Stage 2 ([spec](http://tc39.es/proposal-built-in-modules/), [slides](https://github.com/tc39/proposal-built-in-modules/blob/HEAD/slides/BuiltInModules-For-Stage-2-TC39-Sept-2020-v2.pdf)) | Michael Saboff |
