...
1. Proposals looking to advance to stages 2, 3, or 4, as well as other normative changes to the standard or proposals in stage 3 looking to achieve consensus, must be added (and noted as such) *along with links to the necessary materials* prior to the deadline, or else delegates may withhold consensus solely on the basis of missing the deadline.
    ...
    1. For normative changes, the committee is expected to be lenient about granting exceptions to the deadline in cases of urgency, since there is generally less material to review than in a stage advancement.
