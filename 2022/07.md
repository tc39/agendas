...
1. Proposals
    ...
    |   |     0 |     30m | [Symbol Predicates](https://github.com/rricard/proposal-symbol-predicates) for stage 1 or 2 ([spec](https://www.rricard.me/proposal-symbol-predicates/)) | Jordan Harband & Robin Ricard |
    ...
    |   |     0 |     30m | [Math Between](https://github.com/js-choi/proposal-math-between) for Stage 1 ([slides](https://docs.google.com/presentation/d/1gymNBL5LGBLgE70-YIcI7DwAwUnEgWKnZEtmnFeV4yI/edit?usp=sharing)) | J. S. Choi |
    |   |     0 |     30m | [Math Popcount](https://github.com/js-choi/proposal-math-popcount) for Stage 1 ([slides](https://docs.google.com/presentation/d/1QNhbGydDkFcEbuHxV4g0HjW-HmcMR_rztvSmVg1biS4/edit?usp=sharing)) | J. S. Choi |
