...
1. Proposals
    ...
    |   | 2     | 120m    | [Temporal](https://github.com/tc39/proposal-temporal) for Stage 3 | Philip Chimento |
...
- Shane is unavailable Tuesday afternoon and wants to be present for: Temporal for Stage 3, Unicode set notation in regex, Intl.Segmenter
