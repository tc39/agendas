...
1. Final Draft Standards: Discussion and Approval Votes
  ...
  1. New Standard: ECMAScript Language Suite (Allen Wirfs-Brock) [tc39-2016-013](https://github.com/tc39/agendas/blob/HEAD/2016/tc39-2016-013.pdf)
1. Proposals for future editions of ECMA-262
  ...
  1. Status updates on existing proposals not looking to advance
    ...
    1. ~~[Shared Memory and Atomics](https://github.com/tc39/ecmascript_sharedmem) [Slides](https://github.com/tc39/ecmascript_sharedmem/raw/HEAD/tc39/sharedmem-mar-2016.odp) (Lars Hansen)~~
  ...
  1. New proposals for Stage 1
    ...
    1. ~~[Draft Proposed Frozen Realm API](https://github.com/FUDCo/frozen-realms) (Chip Morningstar, Mark Miller) [Slides](https://github.com/FUDCo/frozen-realms/blob/HEAD/FrozenRealmsPresentation-2016-03-30.pdf)~~
    ...
    1. [Agents (spun out from Shared Memory and Atomics) (tentative)](https://axis-of-eval.org/shmem/agents-formatted.html) [Slides](https://github.com/tc39/ecmascript_sharedmem/raw/HEAD/tc39/agents-mar-2016.odp) (Lars Hansen)
