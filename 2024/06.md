...
1. Proposals
    ...
    | 3     | 90m     | [Temporal](https://github.com/tc39/proposal-temporal) Stage 3 update and scope redution ([slides](https://docs.google.com/presentation/d/1PPMAxVnVjFwRPuJwOvVsw9nZLQ6jDM8Hd5PNO0Grp4I/edit#slide=id.p)) | Philip Chimento |
    ...
    | 2     | 30m     | [joint iteration](https://github.com/tc39/proposal-joint-iteration) for Stage 2.7 ([slides](https://docs.google.com/presentation/d/1Qj5h6MajJnji1obZsXea_cUgfwxur-yT6v-8rBTLqtg/edit?usp=sharing)) | Michael Ficarra |
    ...
    | 1     | 30m     | [Decimal](https://github.com/tc39/proposal-decimal) for stage 2 (slides TBD) | Jesse Alama |
...
- Jordan Harband is only available either the first two hours of each day, or the last two hours of each day; whichever is easier for the chairs to arrange. He would like to be present for his own items, as well as Decimal and Temporal.
