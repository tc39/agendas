...
1. Proposals
    ...
    |   | 3     | 30m     | [Explicit Resource Management](https://github.com/tc39/proposal-explicit-resource-management) Normative Updates and Needs Concensus PRs ([PRs](https://github.com/tc39/proposal-explicit-resource-management/pulls?q=is%3Aopen+is%3Apr+label%3Aneeds-consensus)) | Ron Buckton |
