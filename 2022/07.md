...
1. Proposals
    ...
    |   |     3 |     30m | Remove Order Check in [NumberFormat v3](https://github.com/tc39/proposal-intl-numberformat-v3) and in ECMA402 Intl.DateTimeFormat (slides, PR1, PR2) | Frank Yung-Fong Tang (Google) |
