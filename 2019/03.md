...
1. Proposals
    ...
    | 2 | 30m | [Uniform parsing of quasi-standard Date.parse input
](https://github.com/tc39/proposal-uniform-interchange-date-parsing) for Stage 2 ([slides](https://docs.google.com/presentation/d/1LuJzeR7Y-e-LcQObQesJfJsIVGkiZCMoZhVMO5OxIoc/edit)) | Richard Gibson |
