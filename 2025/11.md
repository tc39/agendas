...
1. Proposals
    ...
    | 1 | 30m | [`await` dictionary](https://github.com/tc39/proposal-await-dictionary/) for Stage 2 or 2.7 ([spec PR](https://github.com/tc39/proposal-await-dictionary/pull/24)) | Ashley Claymore |
