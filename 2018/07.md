...
1. Short (&le;30m) Timeboxed Discussions
    ...
    | timebox | topic | presenter |
    |:-------:|-------|-----------|
    | 30m     | Report on Realms shim Security Review ([slides](https://github.com/tc39/agendas/blob/master/2018/realms-sec-review.pdf)) | JF Paradis, Mark S. Miller, Brian Warner, Dean Tribble |
...
1. Proposals
    ...
    | 1     | 60m     | [Temporal proposal update](https://github.com/tc39/proposal-temporal) | Maggie Pint |
