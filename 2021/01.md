...
1. Secretary's Report (15m, Istvan Sebestyen, https://github.com/tc39/agendas/blob/master/2021/tc39-2021-004-January-meeting-Secretariat-Report.pdf)
...
1. Proposals
    ...
    |:-:|:-----:|:-------:|-------|-----------|
    | | 3 | 10m | ⌛️ [Relative indexing method](https://github.com/tc39/proposal-relative-indexing-method) for stage 4 (Late addition, deprioritize) | Shu-yu Guo |
...
1. Longer or open-ended discussions
    ...
    | ✓ | timebox | topic | presenter |
    |:-:|:-------:|-------|-----------|
    |   | 30m | Brand checking ([discussion](https://es.discourse.group/t/strong-brand-checking-in-javascript/557)) | Daniel Ehrenberg |
    |   | 30m | Revisiting [`RegExp.escape`](https://github.com/benjamingr/RegExp.escape) | Jordan Harband |
    |   | 30m | The nature of protocols in JavaScript ([issue](https://github.com/tc39/proposal-temporal/issues/1294)) (late addition) | Daniel Ehrenberg |
    |   | 45m | Spec complexity and planning for future implementations ([discussion](https://github.com/tc39/ecma402/issues/442)) | Shane F. Carr, Zibi Braniecki |
    |   | 60m | Chartering a Security TG ([Reflector thread](https://github.com/tc39/Reflector/issues/313)) ([slides](https://docs.google.com/presentation/d/1p_Ae5sX2uk595_Gt-3Bnfs6VQfhrFt9Zo27pn6P-r8k/edit)) | Michael Ficarra |
    |   | 60m | Inclusion WG updates and Matrix proposal | Mark Cohen [+] |
