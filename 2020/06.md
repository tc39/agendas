...
1. Proposals
    ...
    |   | 0     | 30m     | [Intl Duration Format](https://github.com/tc39/proposal-intl-duration-format) for Stage 1 [slides](https://bit.ly/tc39-intl-duration-format-stage2) | Younies Mahmoud |
