...
1. Proposals
    ...
    |   | 2     | 30m     | [RegExp Modifiers](https://github.com/tc39/proposal-regexp-modifiers) for Stage 3? ([spec](https://tc39.es/proposal-regexp-modifiers/), slides forthcoming, pending reviews) | Ron Buckton |
    ...
    |   | 1     | 60m     | [Grouped and Auto-Accessors](https://github.com/tc39/proposal-grouped-and-auto-accessors) for stage 2 ([draft spec](https://tc39.es/proposal-grouped-and-auto-accessors/), slides forthcoming) | Ron Buckton |
