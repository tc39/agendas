...
1. Next meeting host and logistics - 2022 Plenary Scheduling (5m)
...
1. Proposals
    ...
    |   | 2   | 30m | [Records & Tuples](https://github.com/tc39/proposal-record-tuple/) update (slides later) | Nicolò Ribaudo |
    ...
    |   | 2   | 20m | [JS Module Blocks](https://github.com/tc39/proposal-js-module-blocks) Update & asking for Stage 3 reviewers (slides TBD) | Ron Surma |
