...
1. Timeboxed agenda items
  1. 15 Minute Items
    ...
    1. Seeking stage `-0.0` for IEEE-754 sign bit ([previously](https://esdiscuss.org/topic/math-sign-vs-0)) (JF Bastien).
  1. 30 Minute Items
...
1. Non-timeboxed agenda items
  ...
  1. Discussion and updates for Stage 0+ Proposals
    ...
    1. Code of conduct--possibilities as guides: [Contributor Covenant](http://contributor-covenant.org/), [Chromium CoC](https://www.chromium.org/conduct), [JSConf CoC](http://jsconf.com/codeofconduct.html), [JSFoundation CoC](https://js.foundation/conduct/) (Champion TBD, fallback: Daniel Ehrenberg)
    1. Discuss diversity and inclusion goals (Champion TBD, fallback: Daniel Ehrenberg)
