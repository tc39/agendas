...
1. Proposals
    ...
    |   | 3     | 60m     | Problems with import assertions for module types and a possible general solution | Nicolò Ribaudo |
...
- Anne van Kesteren can only attend in the first two hours of any day, and wants to be present for the "Problems with import assertions for module types" presentation
