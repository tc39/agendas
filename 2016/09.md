...
1. Timeboxed overflow from previous meeting
  1. 15 Minute Items
    1. Do we want to revisit class "mixins" (ie. where the "super" is just an object)? (Rick Waldron)
      1. https://github.com/rwaldron/tc39-notes/blob/master/es6/2012-07/july-26.md#maxmin-class-semantics
      2. https://github.com/rwaldron/tc39-notes/blob/master/es6/2013-01/jan-31.md#class-extends-throw-on-non-constructor
  1. 30 Minute Items
