...
1. Timeboxed agenda items
    1. 15-minute items
        ...
        1. Debugger operands for stage 1 ([github](https://github.com/bmeck/proposal-debugger-operands))
        1. Logical Assignment Operators for Stage 1 ([github](https://github.com/jridgewell/proposal-logical-assignment))
    1. 30-minute items
        ...
        1. Richer Keys for stage 1 ([slides](https://docs.google.com/presentation/d/1q3CGeXqskL1gHTATH_VE9Dhj0VGTIAOzJ1cR0dYqDBk/edit#slide=id.p))
        1. Hashbang Grammar for Stage 2 ([github](https://github.com/bmeck/proposal-hashbang))
    ...
    1. 45-minute items
        1. REPL Goal Symbol for stage 1 ([github](https://github.com/bmeck/js-repl-goal))
    1. 60-minute items
        ...
        1. Decorators for Stage 3 (Daniel Ehrenberg) ([explainer](https://github.com/tc39/proposal-decorators/), [spec](https://tc39.github.io/proposal-decorators/))
