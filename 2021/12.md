...
1. Proposals
    ...
    |   | 2     | 45m     | [RegExp set notation + Unicode properties of strings](https://github.com/tc39/proposal-regexp-set-notation) for Stage 3 (slides, [proposed changes in doc](https://docs.google.com/document/d/1Tbv3hfX9CxQtzH9r-JdxJsQZhmmDsidRUKKxg345JV0/edit#heading=h.kijenta0fu5k), [proposed changes in the spec](https://arai-a.github.io/ecma262-compare/?pr=2418)  ) | Markus Scherer and Mathias Bynens |
