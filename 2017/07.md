...
1. Non-timeboxed agenda items
    ...
    1. Stage 0+ proposals looking to advance
        ...
        1. Consider changing `Number.parseInt` and `Number.parseFloat` to avoid converting `undefined`, `null`, and NaN to string, returning NaN for those three input values. This fixes unexpected behavior for radix >= 24.
    1. New proposals
