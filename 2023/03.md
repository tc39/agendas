...
1. Proposals
    ...
    |   | 3 | 30m | Decorators: `[[HomeObject]]` rebinding issue ([issue](https://github.com/tc39/proposal-decorators/issues/497), slides TBD) | Chris Hewell Garrett |
    |   | 3 | 30m | Decorators: undefined `this` value for decorator functions ([issue](https://github.com/tc39/proposal-decorators/issues/487), slides TBD) | Chris Hewell Garrett |
    |   | 2 | 30m | Decorator Metadata updated design and spec ([slides](https://slides.com/pzuraq/decorator-metadata-update-march-2023), spec TBD) | Chris Hewell Garrett |
