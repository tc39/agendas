...
```js
Temporal.ZonedDateTime.from('2023-11-17T10:00[America/Los_Angeles]')
...
1. Proposals
    ...
    |:-:|:-----:|:-------:|-------|-----------|
    |   | 0 | 30m | [Module sync assert for stage 1](https://github.com/Jack-Works/proposal-module-sync-assert) | Jack-Works |
