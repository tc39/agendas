...
1. Proposals
    ...
    | 3 | 15m | [`Array.prototype.flatMap` and `Array.prototype.flat`](https://github.com/tc39/proposal-flatMap) for stage 4 | Michael Ficarra |
    ...
    | 1 | 30m | [Extended Numeric Literals](https://github.com/tc39/proposal-extended-numeric-literals) for Stage 2 ([slides](https://docs.google.com/presentation/d/1S6fX1smQplysYwGCZHQ5kBPLmtahVEOdNF0GHjZee7k/edit?usp=drivesdk)) | Daniel Ehrenberg |
    ...
    |   | 30m | [Built-in decorators](https://github.com/littledan/proposal-built-in-decorators/) for Stage 1 ([slides](https://docs.google.com/presentation/d/1HsbE-5l7CIHEQ60LMBKvHxmVHORh5NXujSNFMlNDdTQ/edit#slide=id.p)) | Daniel Ehrenberg |
...
1. Longer or open-ended discussions
    ...
    | 15m | Overloading method parameters between BigInt and Number: Just Say No (?) | Daniel Ehrenberg |
