...
The building at 46 West 24th St has turnstiles which require security badges to enter the building. Guests will need to provide their name and government-issued ID to have their badges printed. The badges are good for all three days (but can be replaced if they get lost)
  * <details>
      <summary><a href="https://snaps.akibraun.com/sakok.JPG">This is what the entrance looks like</a></summary>

      ![This is what the entrance looks like](https://snaps.akibraun.com/sakok.JPG)
    </details>
  * <details>
      <summary><a href="https://snaps.akibraun.com/2cg1r.JPG">This is on the floor after security!</a></summary>

      ![This is on the floor after security!](https://snaps.akibraun.com/2cg1r.JPG)
    </details>
  * <details>
      <summary><a href="https://snaps.akibraun.com/wti4z.JPG">After riding the elevator down to LL, this will be our room(s)</a></summary>
...
1. ~~Project Editors’ Reports~~
    ...
    1. ~~[Test262](https://docs.google.com/presentation/d/1LgxaVZcj4IAIKDtVObwA4HN-w9TlCSFWDGOi8m2xw80/edit#slide=id.p) Status Updates (15m)~~
...
1. ~~Proposals~~
    ...
    | 1 | 15m | ~~[Hashbang for stage 2](https://github.com/tc39/proposal-hashbang)~~ | Bradley Farias |
    ...
    | 1 | 60m | ~~[Temporal for stage 2](https://github.com/tc39/proposal-temporal) ([slides](https://htmlpreview.github.io/?https://github.com/tc39/proposal-temporal/blob/master/September2018Updates.html))~~ | Maggie Pint |
