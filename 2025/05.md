...
1. Short (≤30m) Timeboxed Discussions
    ...
    | 30m     | Yavashark: A New JS/TS Engine | @Sharktheone |
...
1. Proposals
    ...
    | 1 | 30m | [BigInt Math](https://github.com/tc39/proposal-bigint-math/) for Stage 2 ([slides](https://docs.google.com/presentation/d/1dlSK1ZHrOl45RkyCNHJSy12OxTSsA4VJXQEKzkZtNek/edit?usp=sharing)) | J. S. Choi |
...
- Jordan Harband will only be at the last 2 hours of each day, and would like to be present for: Error.isError, BigInt math, SeededPRNG, Assertions, Math.clamp, Iterator chunking, deadline change
