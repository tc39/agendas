...
1. Proposals
    ...
    | ✓ | stage | timebox | topic | presenter |
    |:-:|:-----:|:-------:|-------|-----------|
    |   | 1     | 30m     | Update on [`Object` ~~map~~ iteration](https://github.com/tc39/proposal-object-iteration) ([slides](https://1drv.ms/p/s!As13Waij_jkUqe0X3QmI7R9FfKahkw)) | Jonathan Keslin |
