...
1. Proposals
    ...
    | 3   | 20m | [tc39/ecma262#3397](https://github.com/tc39/ecma262/pull/3397): extend iterator helper string rejection to all primitives, as per normative conventions | Michael Ficarra |
