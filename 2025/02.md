...
1. Proposals
    ...
    |   1   | 60m     | A unified vision for [measure](https://github.com/tc39/proposal-measure/) and [decimal](https://github.com/tc39/proposal-decimal/) ([slides](https://notes.igalia.com/p/tc39-2025-02-plenary-decimal-measure-unity) | Jesse Alama |
    ...
    |   0   | 30m     | [Curtailing the power of "Thenables"](https://github.com/mgaudet/proposal-thennable-curtailment) (Slides TBD) for Stage 1 | Matthew Gaudet |
...
- Eemeli Aro will be unavailable during the afternoons of each day.
- Philip Chimento: mild preference to present ShadowRealm and Temporal back to back, if possible.
- ZiJian Liu: hope to schedule it during the last two hours of the first and second days(15:00 - 17:00 PST), or the last hour of the final day(15:00 - 16:00 PST).
