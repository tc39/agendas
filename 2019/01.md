...
1. Proposals
    ...
    | 0 | 15m | [Freezing prototypes](https://github.com/bakkot/proposal-freeze-prototype) for stage 1 | Kevin Gibbons |
    | 0 | 30m | [Iterator helpers](https://github.com/devsnek/proposal-iterator-helpers) for stage 1 | Domenic Denicola (on behalf of Gus Caplan) |
    | 2 | 30m | [Set methods](https://github.com/tc39/proposal-set-methods) for stage 3 | Sathya Gunasekaran, Michal Wadas |
    | 0 | 30m | [Private Declarations](https://docs.google.com/presentation/d/1Zu9uCFMUU4zLwBVSd3OOxtsm-CYyYvJIryLVGW5leoA/edit?usp=sharing) | Bradley Farias |
