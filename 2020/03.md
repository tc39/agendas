...
1. Project Editors’ Reports
    ...
    1. [ECMA402](https://github.com/tc39/ecma402) Status Updates (15m)
        1. TC39-TG2 Updates ([Slides pending](#)). Shane F. Carr.
        1. ECMA-402 7th Edition (2020) RC Cut ([Link](https://drive.google.com/file/d/1z3v23piIHSBxZnQhbR2bvYNuuzYqDvER/view?usp=sharing)). Leo Balter.
...
1. [Web compatibility issues](https://github.com/tc39/ecma262/issues?utf8=✓&q=is%3Aopen+label%3A%22web+reality%22+is%3Aissue) / [Needs Consensus PRs](https://github.com/tc39/ecma262/pulls?q=is%3Apr+is%3Aopen+label%3A%22needs+consensus%22)
    ...
    |   | 10m     | [Surrogate pairs in RegExp capture group names](https://github.com/tc39/ecma262/pull/1869) ([slides](https://docs.google.com/presentation/d/1pKvUGkTcS5YkCqhJAlr093twy0RKtEmdoN6AGvpbP3Q/edit?usp=sharing))| Kevin Gibbons |
...
- Dan Ehrenberg has some difficult-to-predict conflict on parts of Wednesday and Thursday (not the whole day), and will update this when more information is available. He'd like to be present for the class fields/`?.` topic, Records and Tuples,  Temporal, WeakRefs, Decorators, and Decimal (and ideally remote plenary and process changes for US members), but completely understands if he has to miss some of those, or if some of his presentations need to wait for next meeting, due to the uncertainty.
