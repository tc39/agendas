...
1. ~~(Thursday) Approval of the minutes from last meeting (https://github.com/tc39/agendas/blob/HEAD/2017/March%20minutes%20tc39-2017-010.pdf)~~
...
1. ~~(Wednesday) Talks on Visions for the future of ECMAScript (30 min limit)~~
   ...
   1. ~~Shape Security ([slides](./Shape-Security-ECMA-262-Vision.pdf)) (Kevin Gibbons and Tim Disney)~~
   ...
   1. ~~TC39/ECMAScript: The Next 20 Years [(slides)](https://github.com/tc39/agendas/blob/HEAD/2017/ES-next20.pdf) (Allen Wirfs-Brock)~~
1. Timeboxed agenda items
   ...
   1. 30 Minute Items
      1. ~~`Atomics.waitNonblocking` for Stage 1 ([informal explainer](https://github.com/lars-t-hansen/moz-sandbox/blob/HEAD/sab/waitNonblocking.md)) (Shu-yu Guo, Lars Hansen _in absentia_)~~
   ...
   1. 60 Minute Items
      ...
      1. Module/script pragma, for stage 2 ([proposal](https://github.com/tc39/proposal-modules-pragma); [slides](https://github.com/tc39/agendas/raw/HEAD/2017/tc39-2017-05-use-module.pdf)) (Dave Herman, Yehuda Katz)
