...
Please arrive at the Google entrance to the 111 8th Avenue building, at 15th Street and 8th Avenue. You should be able to sign in from the visitor kiosk, which will print you a badge. (Or, there might be badges ready and waiting; getting that set up is in-progress.)

At that point Domenic or possibly another Googler will escort you to the meeting room.
...
1. Timeboxed agenda items
   1. 15 Minute Items
      ...
      1. [BigInt for Stage 3](https://docs.google.com/presentation/d/1lrcjQzIFgdUXczeeAzs4GkTXJsRQU21UhtmXef70Qic/edit#slide=id.p) ([spec](https://github.com/tc39/proposal-bigint)) (Daniel Ehrenberg)
