...
1. Timeboxed agenda items
 ...
        1. Needs-consensus PR: Fix `length` property of TypedArrays, DataView and ArrayBuffer constructors (Leo Balter, PR by André Bargull) ([PR](https://github.com/tc39/ecma262/pull/1131))
    1. 30-minute items
