...
1. [Web compatibility issues](https://github.com/tc39/ecma262/issues?utf8=✓&q=is%3Aopen+label%3A%22web+reality%22+is%3Aissue) / [Needs Consensus PRs](https://github.com/tc39/ecma262/pulls?q=is%3Apr+is%3Aopen+label%3A%22needs+consensus%22)
    ...
    |:-------:|-------|-----------|
    | 45m | Amending the memory model to support ARMv8 `LDA`/`STL` codegen | Shu-yu Guo & Conrad Watt (invited expert) |
...
1. Short (&le;30m) Timeboxed Discussions
    ...
    | 10m | Publishing the website | Yulia Startsev |
...
1. Proposals
    ...
    | 3 | 15m | [`Array.prototype.flatMap` and `Array.prototype.flat`](https://github.com/tc39/proposal-flatMap) for stage 4 ([PR](https://github.com/tc39/ecma262/pull/1309)) | Michael Ficarra |
    | 3 | 30m | Community (developers and educators) feedback over `globalThis`, advocating for `Global` | Leo Balter (not championing the proposal) |
    ...
    | 2 | 30m | [Set methods](https://github.com/tc39/proposal-set-methods) for stage 3 | Sathya Gunasekaran |
    ...
    |   | 30m | [Operator overloading](https://github.com/littledan/proposal-operator-overloading/) for Stage 0 ([slides](https://docs.google.com/presentation/d/1oGOo0CiyhUHv0iStUtkWfmMJkYdfzXIpCVnciA_lzUg/edit#slide=id.p)) | Daniel Ehrenberg |
    ...
    |   | 30m | [Reserved decorator-like syntax](https://github.com/littledan/proposal-reserved-decorator-like-syntax) for Stage 1 ([slides](https://docs.google.com/presentation/d/1HsbE-5l7CIHEQ60LMBKvHxmVHORh5NXujSNFMlNDdTQ/edit#slide=id.p)) | Daniel Ehrenberg |
...
1. Longer or open-ended discussions
    ...
    | 10m | Documentation of proposals at TC39! ([slides](https://docs.google.com/presentation/d/1uZVUdCt0l_T3DXJ9F_QAsPHcC1q-KlugUmwPqrMSwpU/edit#slide=id.p)) | Daniel Ehrenberg |
    | 30m | TC39 Rationale - A proposed starting point | Yulia Startsev |
...
- The three class topics (private symbols, new.initialize, and private fields/methods refresher) should all be scheduled together.
 - Jordan Harband will also be attending remotely, and will try to call in to the entire meeting.
