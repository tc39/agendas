...
1. Proposals
    ...
    |   | 3     | 10m     | Decorators Normative Change: Flexible Initializers ([slides](https://slides.com/pzuraq/decorators-normative-changes-20    22-06)) | Chris Hewell Garrett |
...
- Jordan Harband (Coinbase) will not be available on June 8th after 2PM local time, and would prefer to be present for anything requesting advancement.
