...
1. [Web compatibility issues](https://github.com/tc39/ecma262/issues?utf8=✓&q=is%3Aopen+label%3A%22web+reality%22+is%3Aissue) / [Needs Consensus PRs](https://github.com/tc39/ecma262/pulls?q=is%3Apr+is%3Aopen+label%3A%22needs+consensus%22)
    ...
    | 10m     | Dynamic modules layering change, for "consensus, awaiting implementation/embedder feedback" ([PR #1306](https://github.com/tc39/ecma262/pull/1306)) | author: Guy Bedford |
...
1. Proposals
    ...
    | 1     | 30m     | Update on Optional Chaining [Optional Chaining](https://github.com/tc39/proposal-optional-chaining) | Dustin Savery |
...
1. Breakout sessions
    ...
    If time permits, we can schedule breakout sessions after the regularly scheduled agenda items. l
    Let's draft breakout topics below, but continue to accept new proposals at the physical meeting.
    
    | topic | discussion prompt |
    |-------|-------|
    | IDL deep dive | Examine the semantics of WebIDL, observe its mismatches and pain points with JS, and think about what we want for IDL in JS |
    | JS standard library infrastructure | How should built-in modules work? |
    | JS standard library contents | What should we put in the JS standard library? |
    | Functional programming in JS | How should JavaScript evolve to better support functional programming? |
    | WebAssembly/JS interaction | Review various WebAssembly proposals for interacting with JS (gc, host-binfings, modules) and discuss ways to improve interaction |
    | Diversity, inclusion and outreach | What are our next steps to improve further? |
    | Shared/remote JS code | Can we enable lightweight, ergonomic ways to run JavaScript code in different threads/processes (e.g. Workers)?|

    Propose your own breakout session with a PR here!
