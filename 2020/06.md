...
1. Proposals
    ...
    |   | 0     | 30m     | Symbols as WeakMap keys for Stage 1 ([repo](https://github.com/rricard/proposal-symbols-as-weakmap-keys)) | Daniel Ehrenberg, Richard Button and Robin Ricard |
