...
Please register before 8th of November 2014.
  ...
  1. ECMA-262 7th Edition and beyond
     ...
     1. `Map.prototype.map` and `Map.prototype.filter` ([spec](https://gist.github.com/DmitrySoshnikov/a218700746b2d7a7d2c8)) + `Set`
     1. Revisit `Set` API (possible exclusion of `entries` and `keys`)
