...
1. Proposals
    ...
    |:-----:|:-------:|-------|-----------|
    | 3 | 10m | Drop `assert` from [import attributes](https://github.com/tc39/proposal-import-attributes) ([PR](https://github.com/tc39/proposal-import-attributes/pull/161), slides TBD) | Nicolò Ribaudo |
